<%-- 
    Document   : contacto
    Created on : 22 dic. 2020, 9:34:30
    Author     : amrsin
--%>

<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="modelo.GestionContactos,java.util.ArrayList,mx.com.gm.sga.Contacto"%>
...
<body>
	...
	<c:choose>
		...
		<c:otherwise>
                    <center><h1>No hay contactos</h1></center>
		</c:otherwise>
	</c:choose>
	<br/>
	<br/>
